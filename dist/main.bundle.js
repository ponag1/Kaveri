...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        document.body.style.backgroundImage = "url('/assets/images/land-patta-1.jpg')";
...
module.exports = "<a href='#' (click)=\"logout()\" style=\"color:white;\"><span class=\"glyphicon glyphicon-log-out\"></span> Logout</a>\n"
        ...
        if (this.noSearchResults == false) {
            ...
            this.manageLandRecordsService.getLandRecordsMojaniByPid(this.pid)
                ...
                if (response != null && response.success) {
                    ...
                    _this.landRecord.ownerDetails = null;
